...
| Production API URL | **https://janna.oybgiveaways.com/api** |
...
- [ ] **Privacy Policy URL** — **required** even for v1 (the app loads
      ...
      (e.g. `https://janna.oybgiveaways.com/privacy`) and add the URL in
...
- [ ] Test the app on **mobile data** (4G/5G, not only local Wi-Fi) to prove
      that `https://janna.oybgiveaways.com/api` is reachable from the public
      internet.
...
- [ ] Verify **images and gallery** load (cover image, provider photos,
      menu/products) — these come from `https://janna.oybgiveaways.com/storage/...`
